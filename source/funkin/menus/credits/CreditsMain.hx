...
class CreditsMain extends TreeMenu {
	...
	public override function create() {
		...
		selectables.push(new TextOption("Codename Engine >", TU.translate("credits.selectCodename"), function() {
			optionsTree.add(Type.createInstance(CreditsCodename, []));
		}));
		selectables.push(new TextOption("Friday Night Funkin'", TU.translate("credits.selectBase"), function() {
			CoolUtil.openURL("https://ninja-muffin24.itch.io/funkin");
		}));

		main = new OptionsScreen(TU.translate("credits.name"), TU.translate("credits.madePossible"), selectables);
		super.create();
