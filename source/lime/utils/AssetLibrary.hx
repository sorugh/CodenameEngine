...
class AssetLibrary
{
	...
	public function checkSpecificAsset(id:String, type:String):Bool
	{
		return switch (type)
		{
			case BINARY: cachedBytes.exists(id) || classTypes.exists(id) || paths.exists(id);
			case FONT: cachedFonts.exists(id) || classTypes.exists(id) || paths.exists(id);
			case IMAGE: cachedImages.exists(id) || classTypes.exists(id) || paths.exists(id);
			case MUSIC, SOUND: cachedAudioBuffers.exists(id) || classTypes.exists(id) || paths.exists(id);
			case TEXT: cachedText.exists(id) || cachedBytes.exists(id) || paths.exists(id);
